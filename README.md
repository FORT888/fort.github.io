...
/* 滚动标题 */
.scroll-container { width:100%; height:40px; overflow:hidden; position:relative; top:5px; }
.scroll-title {
  font-size:28px;
  font-weight:700;
...
<div id="accelerator" class="tab-content active">
  <div class="nav-section">
    ...
    <div class="tutorial-step"><p>步骤三：选择自己的手机型号对应下载</p><img src="images/jiasuqi3.png"></div>
  </div>
</div>
